...
const StudentChangePasswordScreen = () => {
    ...
    const { updatePasswordStudent } = useUserProfile();
    ...
    const handleUpdatePassword = async () => {
        try {
            await updatePasswordStudent(oldPassword, newPassword);
        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <View style={tw`flex-row justify-between w-4/5`}>
                <View style={tw`flex-1 ml-2 mb-5`}>
                    ...
                    <Button mode="contained" style={tw`mb-1`} onPress={() => navigation.navigate("StudentProfile")}> 
                        Never Mind 
                    </Button>
                </View>
            </View>
